                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="promo-detail-col">
                                                        ...
                                                        <p class="promo-date mb-0">Expired date 23 April 2024</p>
                                                    </td>
                                                    <td class="text-right promo-value-col">
                                                        <p class="promo-main-title mb-1">Men Collection</p>
                                                        <span class="badge badge-success promo-badge">Public</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table promo-nested-table border-0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right promo-value-col">
                                                        <p class="promo-main-title mb-1">Women Collection</p>
                                                        <span class="badge badge-success promo-badge">Public</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="promo-detail-col">
                                                        ...
                                                        <p class="promo-date mb-0">Expired date 29 April 2024</p>
                                                    </td>
                                                    <td class="text-right promo-value-col">
                                        ...
                                        <table class="table promo-nested-table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right promo-value-col quantity-sales text-success">
                ...
                <div class="card promo-card">
                    <div class="card-body">
                        ...
                        <div class="btn-group mb-4" role="group" id="filter-group">
                            <button type="button" class="btn btn-sm btn-primary active" data-filter="all">All
                                Promos</button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 mb-5 px-2" style="display: block;">
                                <div class="coupon-card coupon-card-private" data-status="private">
                                    ...
                                    <div class="action-btns">
                                        <button class="edit-btn edit private"><i class="fa-solid fa-pen"></i></button>
                            ...
                            <!-- Public -->
                            <div class="col-12 col-md-4 mb-5 px-2" style="display: block;">
                                <div class="coupon-card full-coupon-card coupon-card-public" data-status="public">
                                    <p class="method">Via Barcode Scan</p>

                                    <div class="action-btns">
                                        <button class="edit-btn edit public"><i class="fa-solid fa-pen"></i></button>
                                        <button class="del-btn delete public"><i class="fa-solid fa-trash"></i></button>
                                    </div>
                                    ...
                                    <div class="footer-row">
                                        ...
                                        <span class="badge public-badge" style="color: #396afc;">Public</span>
                                    </div>
                                    <div class="circle1"></div>
                                    <div class="circle2"></div>
                                </div>
                            ...
                            <div class="col-12 col-md-4 mb-5 px-2" style="display: block;">
                                <div class="coupon-card coupon-card-expired" data-status="expired">
                                    ...
                                    <div class="action-btns">
                                        <button class="edit-btn edit expired"><i class="fa-solid fa-pen"></i></button>
