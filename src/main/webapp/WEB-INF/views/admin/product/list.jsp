                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-warning mr-1" data-id="${product.id}"
                                                ...
                                                onclick="showViolationModal(this)" title="Ẩn sản phẩm">
                                                <i class="typcn typcn-eye-outline"></i>
                                            </button>


                                            <!-- Lock Product -->
                                            <button type="button" class="btn btn-sm btn-danger mr-1" data-id="${product.id}"
                                                data-action="lock" data-name="${product.name}"
                                                onclick="showViolationModal(this)" title="Khóa sản phẩm">
