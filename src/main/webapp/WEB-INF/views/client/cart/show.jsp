                ...
                <div class="container-fluid py-5">
                    <div class="container py-5">
                        <div class="table-responsive">
                            <form action="/cart/update" method="post" modelAttribute="cartDTO">
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <c:choose>
                                    <c:when test="${not empty cart.cartDetails}">
                                    <c:when test="${not empty cart.cartDetails and fn:length(cart.cartDetails) > 0}">
                                        <tbody>
                                            <c:forEach var="item" items="${cart.cartDetails}">
                                            <c:forEach var="item" items="${cart.cartDetails}" varStatus="status">
                                                <input type="hidden" name="cartDetails[${status.index}].id" value="${item.id}" />
                                                    ...
                                                    <td>
                                                        <div class="input-group quantity mt-4" style="width: 100px;">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="cartDetails[${status.index}].quantity" min="1" value="${item.quantity}">
                                                            <div class="input-group-btn">
                                                                <button
